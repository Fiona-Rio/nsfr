"""
Django settings for nsfr project.
...
SECRET_KEY = 'django-insecure-!n3@k0y8jif^2r!x5k!^yub(@_h4=)shvy)vq*6(1b@kg_2$we'
...
WSGI_APPLICATION = 'nsfr.wsgi.application'
...
# Répertoires pour  les fichiers média  
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

#Répertoires pour les fichiers statiques
STATICFILES_DIRS = [
